...
const Elevate = () => {
  return (
    <section className='bg-[radial-gradient(circle_at_top_left,#1a0b2e_10%,#000000_100%)] px-20 py-20 border-t border-[#262527]'>
      <h1 className='text-white text-6xl mb-5'>Elevate your <br />SEO efforts</h1>
      <div className='grid grid-cols-3 text-white'>
        {featuresList.map((feature,index)=>(
            <div key={index} className='flex flex-col'>
                ...
                <p className='text-gray-300 py-3 text-sm max-w-[250px] leading-relaxed'>{feature.description}</p>
            </div>
        ))}
      </div>
    </section>
